...
import '../../models/price_fromat_output.dart';
...
// Furniture widget definition
class Furniture extends StatefulWidget {
  const Furniture({super.key});

  @override
  State<Furniture> createState() => _ElectronicAndAppliencesState();
}

class _ElectronicAndAppliencesState extends State<Furniture> {
                        ...
                        return GestureDetector(
                          onTap: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => ElectroPrdouctView(
  ...
  Stream<QuerySnapshot> fetchAdsDataStream() {
    try {
      ...
      CollectionReference adsCollectionReference =
          FirebaseFirestore.instance.collection('category').doc('Furniture').collection('ads');
