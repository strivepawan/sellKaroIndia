...
class ElectronicAndAppliences extends StatefulWidget {
  const ElectronicAndAppliences({super.key});

  @override
  State<ElectronicAndAppliences> createState() => _ElectronicAndAppliencesState();
}

class _ElectronicAndAppliencesState extends State<ElectronicAndAppliences> {
  late List<AdData> adsData = []; // Declare adsData outside the build method
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Electronic And Applicences'),
      ),
                            ...
                            return GestureDetector(
                              onTap: () {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => ElectroPrdouctView( adId: adsData[index].id, catDocid: 'ElectronicAndAppliences',
  ...
  try {
    ...
    CollectionReference adsCollectionReference =
        FirebaseFirestore.instance.collection('category').doc('ElectronicAndAppliences').collection('ads');
