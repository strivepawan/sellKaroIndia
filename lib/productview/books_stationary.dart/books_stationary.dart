...
class BooksAndStationery extends StatefulWidget {
  const BooksAndStationery({super.key});

  @override
  State<BooksAndStationery> createState() => _ElectronicAndAppliencesState();
}

class _ElectronicAndAppliencesState extends State<BooksAndStationery> {
  late List<AdData> adsData = []; // Declare adsData outside the build method
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('BooksAndStationery'),
      ),
                            ...
                            return GestureDetector(
                              onTap: () {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => ElectroPrdouctView( adId: adsData[index].id, catDocid: 'BookS',
  ...
  try {
    ...
    CollectionReference adsCollectionReference =
        FirebaseFirestore.instance.collection('category').doc('BookS').collection('ads');
