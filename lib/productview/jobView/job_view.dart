...
class JobViews extends StatefulWidget {
  ...
  @override
  State<JobViews> createState() => _ElectronicAndAppliencesState();
}

class _ElectronicAndAppliencesState extends State<JobViews> {
                            ...
                            return GestureDetector(
                              onTap: () {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => JobDetailsPage( adId: adsData[index].id, catDocid: 'Vacancies' ),
                                  ),
                                );
                              },
                              child: Container(
  ...
  try {
    ...
    CollectionReference adsCollectionReference =
        FirebaseFirestore.instance.collection('category').doc('Vacancies').collection('ads');
