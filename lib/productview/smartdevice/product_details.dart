...
import '../../models/bottom_neogaciate.dart';
 // Import the new AdDetails widget

class ElectronicProductView extends StatelessWidget {
  final String adId;
  final String catDocid;

  const ElectronicProductView({super.key, required this.adId, required this.catDocid});
