...
class ServiceView extends StatefulWidget {
  ...
  @override
  State<ServiceView> createState() => _ElectronicAndAppliencesState();
}

class _ElectronicAndAppliencesState extends State<ServiceView> {
                ...
                builder: (context, snapshot) {
                  if (snapshot.connectionState == ConnectionState.waiting) {
                    ...
                    List<AdData> adsData = snapshot.data!.docs.map((DocumentSnapshot document) {
                      ...
                      String salaryperiods = data['salary_period']?? '';
                            ...
                            return GestureDetector(
                              onTap: () {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => ServiceDetailsView( adId: adsData[index].id, catDocid: 'Service',),
                                  ),
                                );
                              },
                              child: Container(
  ...
  try {
    ...
    CollectionReference adsCollectionReference =
        FirebaseFirestore.instance.collection('category').doc('Service').collection('ads');
