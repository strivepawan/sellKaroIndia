...
class SportsAndGyms extends StatefulWidget {
  const SportsAndGyms({super.key});

  @override
  State<SportsAndGyms> createState() => _ElectronicAndAppliencesState();
}

class _ElectronicAndAppliencesState extends State<SportsAndGyms> {
  late List<AdData> adsData = []; // Declare adsData outside the build method
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Sports And Gyms'),
      ),
                            ...
                            return GestureDetector(
                              onTap: () {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => ElectroPrdouctView( adId: adsData[index].id, catDocid: 'Sports and GYM',
  ...
  try {
    ...
    CollectionReference adsCollectionReference =
        FirebaseFirestore.instance.collection('category').doc('Sports and GYM').collection('ads');
