...
class Fashion extends StatefulWidget {
  ...
  @override
  State<Fashion> createState() => _ElectronicAndAppliencesState();
}

class _ElectronicAndAppliencesState extends State<Fashion> {
                            ...
                            return GestureDetector(
                              onTap: () {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => ElectroPrdouctView( adId: adsData[index].id, catDocid: 'Fashion',
  ...
  try {
    ...
    CollectionReference adsCollectionReference =
        FirebaseFirestore.instance.collection('category').doc('Fashion').collection('ads');
