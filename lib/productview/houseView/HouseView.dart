...
class PropertiseView extends StatefulWidget {
  const PropertiseView({super.key});

  @override
  State<PropertiseView> createState() => _ElectronicAndAppliencesState();
}

class _ElectronicAndAppliencesState extends State<PropertiseView> {
  late List<AdData> adsData = []; // Declare adsData outside the build method
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Propertise'),
      ),
                            ...
                            return GestureDetector(
                              onTap: () {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => PropertyDetailsView( adId: adsData[index].id, catDocid: 'Property',
  ...
  try {
    ...
    CollectionReference adsCollectionReference =
        FirebaseFirestore.instance.collection('category').doc('Property').collection('ads');
