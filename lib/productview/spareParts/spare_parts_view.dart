...
class SparePartsView extends StatefulWidget {
  ...
  @override
  State<SparePartsView> createState() => _ElectronicAndAppliencesState();
}

class _ElectronicAndAppliencesState extends State<SparePartsView> {
                            ...
                            return GestureDetector(
                              onTap: () {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => SparePartsDetailsView( adId: adsData[index].id, catDocid: 'SpareParts',
  ...
  try {
    ...
    CollectionReference adsCollectionReference =
        FirebaseFirestore.instance.collection('category').doc('SpareParts').collection('ads');
