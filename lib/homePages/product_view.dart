...
class proDuctComponent extends StatelessWidget {
          ...
          child: Wrap(
            ...
            children: [
              _buildIconTextComponent(
                ...
                onTap: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context) => const VechilesView()));
                },
              ),
              _buildIconTextComponent(
                context,
                ...
                onTap: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context) => const PropertiseView()));
                },
              ),
              _buildIconTextComponent(
                context,
                ...
                onTap: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context) => const PhoneAdCards()));
                },
              ),
              _buildIconTextComponent(
                context,
                ...
                onTap: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context) => const ElectronicAndAppliences()));
                },
              ),
              _buildIconTextComponent(
                context,
                ...
                onTap: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context) => const SparePartsView()));
                },
              ),
              _buildIconTextComponent(
                context,
                ...
                onTap: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context) => const JobViews()));
                },
              ),
              _buildIconTextComponent(
                context,
                ...
                onTap: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context) => const Furniture()));
                },
              ),
              _buildIconTextComponent(
                context,
                ...
                onTap: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context) => const Pets()));
                },
              ),
              _buildIconTextComponent(
                context,
                ...
                onTap: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context) => const Fashion()));
                },
              ),
               _buildIconTextComponent(
                context,
                ...
                onTap: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context) => const SportsAndGyms()));
                },
              ),
  ...
  Widget _buildIconTextComponent(BuildContext context,
      {required String text, required IconData iconData, required void Function() onTap}) {
    return GestureDetector(
      onTap: onTap,
      child: Container(
        width: (MediaQuery.of(context).size.width - 64) / 3, // Ensuring three items per row
