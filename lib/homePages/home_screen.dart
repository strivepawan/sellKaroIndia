...
import 'package:flutter_gen/gen_l10n/app_localizations.dart'; // Import the generated localization files
              ...
              child: Container(
                ...
                child: Row(
                  children: [
                    ...
                    Text(
                      currentCity.length > 10 ? '${currentCity.substring(0, 10)}...' : currentCity,
                      maxLines: 1,
        ...
        children: [
          Expanded(
            ...
            child: GestureDetector(
              onTap: () {
                Navigator.push(context, MaterialPageRoute(builder: (context) =>const  SearchItem()));
              },
              child: Container(
                decoration: BoxDecoration(
          ...
          const SizedBox(width: 6), // Space between the search box and favorite icon
          Expanded(
            flex: 2,
            child: GestureDetector(
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () {
                      ...
                      MaterialPageRoute(builder: (context)=>const proDuctComponent()));
                    },
                    child:  Text(localization.seeAll,style: const TextStyle(
                      fontSize: 16,fontWeight: FontWeight.bold,fontFamily: AutofillHints.addressCity,
    ...
    try {
      ...
      for (String category in categories) {
        CollectionReference adsCollectionReference =
            FirebaseFirestore.instance.collection('category').doc(category).collection('ads');
