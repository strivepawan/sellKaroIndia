...
class TruckForm extends StatefulWidget {
  ...
  TruckForm({required this.nextStep});
...
class _TruckFormState extends State<TruckForm> {
  ...
  'Tata Motors': [
    'Prima', 'Signa', 'LPT', 'Ultra', 'LPS',
    'LPK', 'SE', 'Ace', 'Intra', 'T.7'
  ],
  'Ashok Leyland': [
    'Captain', 'Boss', 'Ecomet', 'Partner', 'U-Truck',
    'Dost', 'Stile', 'Guru', 'Comet', 'Falcon'
  ],
  'Mahindra': [
    'Blazo', 'Furio', 'Jayo', 'Loadking', 'Optimo',
    'Torito', 'Jeeto', 'Bolero Pik-Up', 'Imperio', 'Alfa'
  ],
  'Eicher': [
    'Pro 6000', 'Pro 5000', 'Pro 3000', 'Pro 2000', 'Pro 1000',
    'Terra 25', 'Starline', 'Skyline', 'Eicher 11.10', 'Eicher 10.75'
  ],
  'BharatBenz': [
    '1923C', '1217C', '2528C', '1617R', '1015R',
    '1214R', '1917R', '3128C', '4028T', '2823C'
  ],
  'Volvo': [
    'FH', 'FM', 'VNL', 'VNR', 'VAH'
  ],
  'Mercedes-Benz': [
    'Actros', 'Arocs', 'Antos', 'Atego'
  ],
  'Scania': [
    'R Series', 'S Series', 'P Series', 'G Series'
  ],
  'MAN': [
    'TGX', 'TGS', 'TGM', 'TGL'
  ],
  ...
  Future<String> uploadImage(File imageFile) async {
    final Reference storageReference = _firebaseStorage.ref().child('trucks/${path.basename(imageFile.path)}}');
  ...
  void handleSubmit() async {
    if (_formKey.currentState!.validate()) {
      try {
        ...
        // Post data to the "trucks" subcollection under the main collection "Automobiles"
