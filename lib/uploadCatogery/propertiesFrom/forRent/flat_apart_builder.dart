...
class FlatApartBuilder extends StatefulWidget {
  const FlatApartBuilder({super.key});

  @override
  _FlatApartBuilderState createState() => _FlatApartBuilderState();
}

class _FlatApartBuilderState extends State<FlatApartBuilder> {
