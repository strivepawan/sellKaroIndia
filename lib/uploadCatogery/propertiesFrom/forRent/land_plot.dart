...
class LandPlotFrom extends StatefulWidget {
  const LandPlotFrom({super.key});

  @override
  _LandPlotFromState createState() => _LandPlotFromState();
}

class _LandPlotFromState extends State<LandPlotFrom> {
          ...
          child: Column(
            ...
            children: [
              ...
              CustomDropdownFormField(
                ...
                items: const ['East', 'West', 'North', 'South', 'Others'],
                hintText: 'Select Facing',
              ),
              const SizedBox(height: 16.0),
              const Text("Enter Area (sq. yards)"),
              CustomTextFormField(
                onChanged: (value) {
                  setState(() {
              ...
              //   onChanged: (value) {
              //     setState(() {
              //       maintenanceMonth = int.tryParse(value) as String?;
              //     });
              //   },
              //   keyboardType: TextInputType.number,
              //   decoration: InputDecoration(
              //     hintText: 'Enter Maintenance (Months)',
              //     filled: true,
              ...
              //   onChanged: (value) {
              //     setState(() {
              //       totalFloors = int.tryParse(value) as String;
              //     });
              //   },
              //   keyboardType: TextInputType.number,
              //   decoration: InputDecoration(
              ...
              //   onChanged: (value) {
              //     setState(() {
              //       carParking = int.tryParse(value) as String;
              //     });
              //   },
              //   keyboardType: TextInputType.number,
              //   decoration: InputDecoration(
