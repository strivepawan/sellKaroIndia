...
class ShoopOfficeShowroomSale extends StatefulWidget {
  const ShoopOfficeShowroomSale({super.key});

  @override
  _ShoopOfficeShowroomSaleState createState() => _ShoopOfficeShowroomSaleState();
}

class _ShoopOfficeShowroomSaleState extends State<ShoopOfficeShowroomSale> {
          ...
          child: Column(
            ...
            children: [
              ...
              CustomDropdownFormField(
                ...
                items: const ['1', '2', '3', '4', '5', 'More than 5'],
