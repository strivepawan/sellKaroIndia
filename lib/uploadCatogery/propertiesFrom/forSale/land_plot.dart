...
class LandPlotFromSale extends StatefulWidget {
  const LandPlotFromSale({super.key});

  @override
  _LandPlotFromSaleState createState() => _LandPlotFromSaleState();
}

class _LandPlotFromSaleState extends State<LandPlotFromSale> {
