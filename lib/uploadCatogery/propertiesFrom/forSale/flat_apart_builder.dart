...
class FlatApartBuilderSale extends StatefulWidget {
  const FlatApartBuilderSale({super.key});

  @override
  _FlatApartBuilderSaleState createState() => _FlatApartBuilderSaleState();
}

class _FlatApartBuilderSaleState extends State<FlatApartBuilderSale> {
          ...
          child: Column(
            ...
            children: [
              ...
              CustomDropdownFormField(
                ...
                items: const ['Flat', 'Apartments', 'Builder Floors'],
              ...
              CustomDropdownFormField(
                ...
                onChanged: (newValue) {
                  setState(() {
                    selectedConstructionStatus = newValue;
                  });
                },
                items: const ['New construction', 'Ready to move', 'Under construction'],
              ...
              const SizedBox(height: 16.0),
              const Text("Area in square yard"),
              CustomTextFormField(
                onChanged: (value) {
                  setState(() {
                    superBuiltUpArea = int.tryParse(value) as String?;
                  });
                },
                keyboardType: TextInputType.number,
                hintText: 'Enter Area in square yard',
              ),
              const SizedBox(height: 16.0),
              ...
              CustomTextFormField(
                onChanged: (value) {
                  setState(() {
                    carpetArea = int.tryParse(value) as String?;
                  });
                },
                keyboardType: TextInputType.number,
