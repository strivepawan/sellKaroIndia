...
class PropertyFormsale extends StatefulWidget {
  const PropertyFormsale({super.key});

  @override
  _PropertyFormsaleState createState() => _PropertyFormsaleState();
}

class _PropertyFormsaleState extends State<PropertyFormsale> {
      ...
      try {
        ...
        Future.delayed(Duration.zero, () {
          Navigator.push(
            ...
            debugPrint('Navigation to ContactUser completed.');
          }).catchError((error) {
            debugPrint('Error navigating to ContactUser: $error');
          });
        });
      } catch (error) {
        setState(() {
          ...
          child: Column(
            ...
            children: [
              ...
              CustomDropdownFormField(
                ...
                items: const ['New Construction', 'Under Construction'],
              ...
              CustomDropdownFormField(
                ...
                items: const ['Yes', 'No'],
                hintText: 'Select Parking Availability',
              ),
              const SizedBox(height: 16.0),
              const Text("Title *"),
              CustomTextFormField(
