...
class SpareParts extends StatefulWidget {
  ...
  const SpareParts ({super.key, required this.whichType});
    ...
    if (_formKey.currentState!.validate()) {
      try {
        ...
        await documentRef.set({
          ...
          'images': imageUrls,
          'SpareType': selectedSpareType.toString().split('.').last,
            ...
            child: Padding(
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [  const  Text('Spare Type *'),
                    DropdownButtonFormField<SpareType>(
                      value: selectedSpareType,
                      onChanged: (newValue) {
                        setState(() {
                          selectedSpareType = newValue;
                        });
                      },
                      items: SpareType.values.map((period) {
