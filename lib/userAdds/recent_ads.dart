                                        ...
                                        Row(
                                          children: [
                                            ...
                                            Container(
                                              ...
                                              child: IconButton(
                                                icon: const FaIcon(FontAwesomeIcons.pen, color: Colors.green),
                                                onPressed: () {
                                                  Navigator.push(
                                                    context,
                                                    MaterialPageRoute(
                                                      builder: (context) => EditData(
                                                        whichType: docId,
                                                        docName: doc.id, // Replace with the actual document ID you want to edit
                                                      ),
                                                    ),
                                                  );
                                                  debugPrint('Navigating to EditData with whichType: $docId, docName: ${doc.id}');
                                                },
                                              ),
                                            ),
                                          ],
